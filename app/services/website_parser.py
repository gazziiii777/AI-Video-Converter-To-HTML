...
class WebsiteParser:
    ...
    async def download_images(self, url: str, output_dir: str = "downloaded_images") -> list:
        """
    ...
    async def save_clean_page_content(self, url: str, output_dir: str = "clean_pages") -> dict:
        """
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                # Получаем и сохраняем HTML
                html = await page.content()
                with open(result['html_file'], 'w', encoding='utf-8') as f:
                    f.write(html)
                ...
                for f in [result['html_file'], result['text_file']]:
    ...
    def filter_images_by_size(
        ...
        if verbose:
            ...
            print(f"Всего проверено: {results['total']}")
            print(f"Удалено: {results['deleted']}")
            print(f"Оставлено: {results['remaining']}")
